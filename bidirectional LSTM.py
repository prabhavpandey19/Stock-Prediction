...
regressior.add(Bidirectional(LSTM(units = 60, activation = 'relu', return_sequences = True, input_shape= (X_train.shape[1], 5,5) )))
...
regressior.add(Bidirectional(LSTM(units = 120, activation = 'relu')))
regressior.add(Dropout(0.2))
